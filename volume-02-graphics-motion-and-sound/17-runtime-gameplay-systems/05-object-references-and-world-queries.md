...
- **查找抛射物路径上或对某个目标点具有视线的所有对象**。碰撞系统通常会被用于执行这类游戏对象查询。大多数碰撞系统都提供快速射线投射；有些还提供将其他形状（例如球体或任意凸体）投射到世界中，以确定它们命中了什么的能力。（见 [Section 14.3.7](../14-collision-and-rigid-body-dynamics/03-the-collision-detection-system.md#1437-碰撞查询)。）
