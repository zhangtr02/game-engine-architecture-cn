...
### 2.1.3 Subversion 与 TortoiseSVN 概览
...
**Figure 2.1.** TortoiseSVN 初始检出对话框。
...
**Figure 2.2.** TortoiseSVN 用户认证对话框。
